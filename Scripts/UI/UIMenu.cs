...
namespace GodotModules
{
    public class UIMenu : Node
    {
        ...
        private async void _on_Play_pressed() => await _sceneManager.ChangeScene(GameScene.Game);
        private async void _on_Multiplayer_pressed() 
        {
            ...
            await _sceneManager.ChangeScene(GameScene.GameServers);
        }
        private async void _on_Options_pressed() => await _sceneManager.ChangeScene(GameScene.Options);
        private async void _on_Mods_pressed() => await _sceneManager.ChangeScene(GameScene.Mods);
        private async void _on_Credits_pressed() => await _sceneManager.ChangeScene(GameScene.Credits);
